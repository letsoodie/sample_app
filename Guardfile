...
# The Gemfile in Listing 3.2 has already included the guard gem in our application, so to get started we just need to initialize it: $ bundle exec guard init
